        ...
        <div class="container rounded bg-white mt-5 mb-5">
            <div class="row">
                <div class="col-md-3 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><br><span class="font-weight-bold">{{$coordinator->coor_name}}</span><br><span class="text-black-50">{{$coordinator->email}}</span><span> </span></div>
                </div>
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-12"><label class="labels">Phone</label><input type="text" class="form-control"value="{{$coordinator->phone}}"></div>
                            <div class="col-md-12"><label class="labels">DOB</label><input type="text" class="form-control" value="{{$coordinator->dob}}"></div>
                            ...
                            <div class="col-md-12"><label class="labels">Picture</label><input type="text" class="form-control" value="{{asset($coordinator->proifle_image)}}"></div>
