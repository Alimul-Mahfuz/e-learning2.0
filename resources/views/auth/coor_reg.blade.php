...
<head>
    ...
    <style>
        .coorRegTitle {
            ...
            background: -webkit-linear-gradient(to right, ##0080FF, ##C4C4C4);
        ...
        <div class="container">
            <form action="" method="post"  enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <!-- Acccount type which 4 -->
                    <div class="col-md-6">
                        <br>
                        <label for="inputconfirmPassword4" class="form-label">Acount type(4 for Coordinator)</label>
                        <input type="text" value="{{old('type')}}" name="type" class="form-control" id="inputconfirmPassword4" placeholder="type 4">
                        @error('type')
                        <span class="text-danger">{{$message}}</span><br>
                        @enderror
                    </div>
